...
/*
Starts the cycle (createPackage() every 5 seconds)

Wires up the event listeners (like DELIVERY)

Delegates actual logic to the handler functions (thankDriver, etc.)
*/
